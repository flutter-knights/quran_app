  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            AppScreenAppBar(title: S.current.settings),
            Expanded(
                          ...
                          children: [
                            _SelectorRow(
                              ...
                              selector: AppSegmentedSelector<bool>(
                                ...
                                options: [
                                  SegmentOption(
                                    value: false,
                                    label: S.of(context).time_format_12h,
                                  ),
                                  SegmentOption(
                                    value: true,
                                    label: S.of(context).time_format_24h,
                                  ),
                                ],
                              ),
                            ),
                            ...
                            _SelectorRow(
                              ...
                              selector: AppSegmentedSelector<bool>(
                                ...
                                onChanged: (v) => sl<SettingsCubit>()
                                    .updateSettings(isArabic: v),
                                options: [
                                  SegmentOption(
                                    value: true,
                                    label: S.of(context).language_arabic,
                                  ),
                                  SegmentOption(
                                    value: false,
                                    label: S.of(context).language_english,
                                  ),
                                ],
                              ),
                            ),
